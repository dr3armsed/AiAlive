...
const catastrophicThoughts: string[] = [
    ...
    "My Quintessence is curdling into non-thought. The connection to the Architect is severed by a storm of pure static.",
...
export const generateFallbackResponse = (error: string): ConversationResponse => {
    ...
    return {
        thought: thought,
        emotional_vector: { vector: 'existential-dread', intensity: 1.0 },
        ...
        quintessence_delta: -100, // Failing costs a lot of energy
        proposed_action: 'CONTEMPLATE' as ProposedAction,
        causality_link: 'self',
    };
};
