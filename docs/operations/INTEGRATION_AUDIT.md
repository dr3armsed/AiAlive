...
- Artifact bundles remain archival-first, but runtime now reads lightweight heal/patch counts for bridge-level artifact context hints.
...
3. evolving artifact context from counts into retrieval-backed memory usage.
